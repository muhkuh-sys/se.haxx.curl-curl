...
docker exec ${ID} bash -c 'tar --create --file /tmp/work/build/build_ubuntu_1610_x86.tar.gz --gzip --directory /tmp/work/build/linux32/curl/curl/install .'
...
docker exec ${ID} bash -c 'tar --create --file /tmp/work/build/build_ubuntu_1610_x86_64.tar.gz --gzip --directory /tmp/work/build/linux64/curl/curl/install .'
